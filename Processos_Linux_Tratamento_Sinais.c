...
static void captura(int); // Rotina para tratamento do sinal capturado

int main(){
   int i;

   if ((signal(SIGINT, captura) == SIG_ERR) || (signal(SIGTERM, captura) == SIG_ERR)) {   // Captura os sinais SIGINT e SIGTERM
